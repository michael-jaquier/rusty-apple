...
export function wasm_bindgen__convert__closures__invoke2_mut__he809f4526f7da3f0(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h3fb0004fd5f36e84(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h0b3d0959a1f49faa(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h97b1eb1e3d064179(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h5909c906680b6105(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h2e07b3832863683a(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2543ba980686c6ef(a: number, b: number, c: number): void;
